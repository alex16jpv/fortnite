      ...
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 font-medium">
            Discover today's exclusive items
          </p>
        </header>
      ...
      <div className="relative z-10">
        ...
        <div className="aspect-square overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 p-2">
          <img
            ...
            alt={`${item?.displayName} - ${
              item?.rarity?.name || "Common"
            } rarity ${item?.displayType || "cosmetic"} in Fortnite for ${
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span
              className={`px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r ${getRarityGradient(
                item?.rarity?.name || "common"
              )} shadow-lg`}
            >
            ...
            <div className="flex items-center space-x-1">
              <span className="text-blue-400 font-bold text-lg">
                {formatPrice(item?.price?.finalPrice || 0)}
              </span>
              <svg
